// @observablehq/runtime v5.6.0 Copyright 2023 Observable, Inc.
function e(e, t, n) {
  n = n || {};
...
const Ne = Ce("d3", "7.8.4", "dist/d3.min.js"),
  ...
  Te = Ce("@observablehq/plot", "0.6.5", "dist/plot.umd.min.js"),
      ...
      return (function (e, t) {
        ...
        let { columns: r } = e,
          { schema: o, inferred: a } = (function (e) {
            ...
            if (!$t(n))
              return (
                (n = dn(e, St(t) ? t : void 0)), { schema: n, inferred: !0 }
              );
...
var xn = Object.freeze({
  ...
  element: function (e, t) {
    ...
    var a = gn.hasOwnProperty(r)
      ? document.createElementNS(gn[r], e)
    ...
    function (e) {
      ...
      Object.defineProperties(
        ...
        ((n = {
              ...
              return Promise.all([
                ...
                function r(e) {
                  return function () {
                    ...
                    return (
                      t.render(Fn.apply(String, arguments), n, e),
          ...
          Inputs: () =>
            t(xe.resolve()).then((e) => ({ ...e, file: e.fileOf(vn) })),
          L: () =>
            (async function (e) {
  ...
  _computeNow: {
    value: async function () {
      ...
      do {
        ...
        e.forEach(function (t) {
          cr(t) &&
            (hr(t, new RuntimeError("circular definition")),
            t._outputs.forEach(ur),
            e.delete(t));
        });
      } while (e.size);
      function o(e) {
